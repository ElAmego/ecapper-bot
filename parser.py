            ...
            for url in urls:
                ...
                match type_of_match:
                    case 'soccer_1x2':
                        ...
                        if len(last_row) != 0 and (('red2' or 'red3') in last_row[3]['class']):  # Red signal
                            print('Signal red HOME')
                            msg = (f'🏆{data_match["league"]}\n⚽{data_match["opponents"]}\n'
                                   f'⏰{data_match["last_row"][1].text}\n🔎Signal red HOME\n➡️{url}')

                        elif len(last_row) != 0 and (('red2' or 'red3') in last_row[6]['class']):
                    ...
                    case 'total':
                        ...
                        if len(last_row) and (last_row[9].text != ('0-1' or '1-0')):
                            ...
                            if handicap_from_the_db and handicap and (handicap - float(handicap_from_the_db) < 1):
                                deviation = get_deviation(collection_config)
                    ...
                    case 'basketball_total':
                        ...
                        if ('red3' in last_row[3]['class']) and ('green3' in last_row[4]['class']):
